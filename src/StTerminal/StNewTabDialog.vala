namespace StillTerminal {
    ...
    public class StProfileTypeSelectorPage : Adw.NavigationPage {
        ...
        public StProfileTypeSelectorPage() {
            ...
            system_button.toggled.connect((btn) => { if (btn.active) this.selected_type = StProfileType.SYSTEM; });
            ...
            container_button.toggled.connect((btn) => { if (btn.active) this.selected_type = StProfileType.DISTROBOX; });
            ...
            ssh_button.toggled.connect((btn) => { if (btn.active) this.selected_type = StProfileType.SSH; });
