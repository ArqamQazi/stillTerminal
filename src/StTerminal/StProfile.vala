namespace StillTerminal {
    ...
    public class StProfile : GLib.Object {
        ...
        public Gee.HashMap<string, string> as_hash () {
            ...
            if (this.spawn_command != null) {
                hash["spawn_command"] = this.spawn_command;
            }
            if (this.profile_file != null) {
                hash["profile_file"] = this.profile_file;
            }
            if (this.icon_name != null) {
                hash["icon_name"] = this.icon_name;
            }
            ...
            if (this.type_subtitle != null) {
                hash["type_subtitle"] = this.type_subtitle;
            }
            return hash;
        }
